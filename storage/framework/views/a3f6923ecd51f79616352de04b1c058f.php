                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div id="productListDiv">
                            <div class="table-responsive"> 
                                <table class="table">
                                    ...
                                    <?php echo $__env->make('includes/product_list',['result'=>$result], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </table> 
                            </div>
                        </div>
                    ...
                    <div class="offcanvas offcanvas-end" id="add-new-record">
                        ...
                        <div class="offcanvas-body flex-grow-1">
                            <div id="add-msg"></div>
                            <form class="add-new-record pt-0 row g-2" id="add-record" onsubmit="return validateProduct('add-record');" action="<?php echo e(url('add-product')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?> 
...
<?php echo $__env->make('includes/footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php /**PATH D:\xampp_8.1.6\htdocs\product_crud\resources\views/product.blade.php ENDPATH**/ ?>